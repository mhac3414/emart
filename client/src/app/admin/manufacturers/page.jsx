...
import DeleteModalManufacturer from "../../../components/DeleteModalManufacturer";
...
export default function Page() {
  ...
  function deleteManufacturer(id) {
    Axios.delete(`/manufacturer/${id}`).then((res) => {
      if (res.data.messageType === "error") {
        setToastType(res.data.messageType);
        setToastMessage(res.data.message);
        setTimeout(() => {
  ...
  const updateManufacturer = async (e) => {
    ...
    try {
      ...
      await Axios.put(`/manufacturer/${toUpdate._id}`, formData).then((res) => {
        if (res.data.messageType === "error") {
          setToastType(res.data.messageType);
          setToastMessage(res.data.message);
          setTimeout(() => {
      ...
      {loading ? (
        ...
        <div className="flex flex-col">
          ...
          {!open ? (
            ...
            <CreateManufacturer setOpen={setOpen} />
          )}
          {deleteModal ? (
            <DeleteModalManufacturer
